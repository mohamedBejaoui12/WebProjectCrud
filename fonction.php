...
function htmlHeader($title,$active1,$active2,$active3){
    echo <<<EOT
    <!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="container-fluid">
    ...
    >
      ...
      <ul class="navbar-nav mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link $active2" aria-current="page" href="reservation.php">Reservations</a>
        </li>
        <li class="nav-item">
          <a class="nav-link $active3" aria-current="page" href="aboutUs.php">aboutUs</a>
        </li>
